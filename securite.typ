#align(center, text(17pt)[
  *Politique de sécurité de Renn.es*
])
...
Au moins l'une de ces personnes a accès à l'infrastructure physique et notifie les membres de toute opération l'impactant.
...
L'association peut faire appel à des prestataires externes, par exemple pour l'hébergement de serveurs privés virtuels (VPS) ou pour du stockage de sauvegardes. Les données transitant par ces services doivent restér chiffrées, pour ne pas diluer la confiance. Cela permet une limitation des fuites de données possibles.
